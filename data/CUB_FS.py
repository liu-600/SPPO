...
_CUB_FS_DATASET_DIR = '/HDD/liuyuanyuan/cub'
...
class CUB_FS(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False):
        ...
        if self.phase=='train':
            ...
            print("train.labelIds:",self.labelIds)
            ...
            self.labelIds = self.labelIds_novel
            print("test.labelIds:",self.labelIds)
            self.num_cats_base = len(self.labelIds_base)
...
class FewShotDataloader():
    def __init__(self,
        ...
        print("max_possible_nKbase:",max_possible_nKbase)
        ...
        print("batchsize:",batch_size,"epochsize:",epoch_size)
    ...
    def sample_base_and_novel_categories(self, nKbase, nKnovel):
        ...
        Args:
            nKbase: number of base categories基类数量
            nKnovel: number of novel categories新类数量
